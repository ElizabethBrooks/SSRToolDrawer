...
In addition to the novel scripts, two previously written scripts were used (https://git.io/JTYMb). FindReadLengths.py was used to verify our sequence capture had worked correctly, and SnipVCF.py to filter downstream SNPs. 
