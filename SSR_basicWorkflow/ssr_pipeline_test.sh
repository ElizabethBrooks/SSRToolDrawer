...
#Usage: qsub ssr_pipeline_test.sh inputsFile
#Usage Ex: qsub ssr_pipeline_test.sh inputPaths_romero_run1.txt
#Usage Ex: qsub ssr_pipeline_test.sh inputPaths_romero_run2.txt
#Usage Ex: qsub ssr_pipeline_test.sh inputPaths_romero_run3.txt
#Usage Ex: qsub ssr_pipeline_test.sh inputPaths_romero_run4.txt
#Usage Ex: qsub ssr_pipeline_test.sh inputPaths_romero_run5.txt
